...
| `rocket_chat_pgp_keyserver` | keyserver.ubuntu.com | The PGP key server to use when importing PGP keys |
| `rocket_chat_mongodb_pgp_key` | `7F0CEB10` | The GPG key fingerprint to import for the MongoDB repo |
