...
| `rocket_chat_mongodb_user` |  UNSET | MongoDB user (Advanced use only). Only set this if you use this! |
| `rocket_chat_mongodb_password` | UNSET | MongoDB password (Advanced use only). Only set this if you use this! |
